...
<head>
    ...
    <!--UKLJUCIVANJE SKRIPTE I CSS-A ZA AUTOCOMPLETE-->
            ...
            if ($('#datum').val() == '') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        //DODAVANJE AUTOCOMPLETE-A SELECT LISTI ZA PARTNERE
                        $("#lista_partnera").select2();
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].konto[0] == 4 && data[i].iznos > 0 ) {
                ...
                duguje += "<div class='rasporedi_inpute'>" +
                                ...
                                "<div class='poravnaj'>" +
                                    "<label class='donja_margina' for='opis_duguje" + brojac + "'>Opis dokum: </label>" +
                                    "<input class='flex_item opis_duguje' id='opis_duguje" + brojac + "' type='text' value='' maxlength='100'>" +
                                "</div>" +
            ...
            //AKO JE VREDNOST KOLONE POTRAZUJE U GLAVNOJ KNJIZI VECA OD NULE,GENERISI RED NA POTRAZNOJ STRANI    
                ...
                potrazuje += "<div class='rasporedi_inpute'>" +
                                ...
                                "<div class='poravnaj'>" +
                                    "<label class='donja_margina' for='opis_potrazuje" + brojac2 + "'>Opis dokum: </label>" +
                                    "<input class='flex_item opis_potrazuje' id='opis_potrazuje" + brojac2 + "' type='text' value='' maxlength='100'>" +
                                "</div>" +
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.cekiraj_duguje', function(){  
            ...
            { 
                ...
                var opis_duguje = $("#opis_" + id).val();

                //FUNKCIJA NA IZMENU POLJA OPIS DOKUMENTA
                $("#opis_" + id).bind('input', function() {

                    opis_duguje = $(this).val();
                ...
                niz_podaci_duguje = [id, iznos, konto_duguje, broj_duguje, kanal_duguje, opis_duguje];
            ...
            //AKO JE SELEKTOVANI PREDLOG ODCEKIRAN
                ...
                //RESETOVANJE POLJA OPIS DOKUMENTA
                $("#opis_" + id).val('');
        ...
        //FUNKCIJA ZA SABIRANJE I ODUZIMANJE CEKIRANIH IZNOSA NA STRANI POTRAZUJE
        $(document).on('click', '.cekiraj_potrazuje', function(){  
            ...
            { 
                ...
                var opis_potrazuje = $("#opis_" + id).val();

                //FUNKCIJA NA IZMENU POLJA OPIS DOKUMENTA
                $("#opis_" + id).bind('input', function() {

                    opis_potrazuje = $(this).val();
                    ...
                    for (var i = 0; i < niz_potrazuje.length; i++) {
                        ...
                        if (id === niz_potrazuje[i][0]) {
                            ...
                            niz_potrazuje[i][5] = opis_potrazuje;
                        }
                    } 
                            ...
                            //AKO JE SVE U REDU,NASTAVI DALJE
                               ...
                               // if (Math.round($(this).val() * 100.0) / 100.0 != stari_iznos) {
                                    ...
                                    for (var i = 0; i < niz_potrazuje.length; i++) {
                                        ...
                                        //AKO SE BROJ REDA POKLAPA SA ID-JEM,AZURIRA SE IZNOS
                                        if (id_potrazuje === niz_potrazuje[i][0]) {
        ...
        <div id="container">
            ...
            <div id="content">
                <div id="trazi_podatke">
                    ...
                    <input id="datum" autocomplete="off" readonly="true"/>
                ...
                <div class="centriraj_dugme">
                    ...
                    <input type="text" id="broj_kompenzacije" maxlength="5" placeholder="Unesite broj kompenzacije">
