...
if (isset($_POST['id_kompenzacije'])) {
    ...
    $upit = "SELECT DISTINCT * FROM kompenzacija_stavke WHERE kompenzacija_zaglavlje_id = ".$_POST['id_kompenzacije']." ORDER BY kompenzacija_stavke_id";
